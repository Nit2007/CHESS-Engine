...
void AddWhitePawnCapMove(const s_board *pos , const int from , const int to ,const int cap ,  const s_movelist *list)
{
...
void AddWhitePawnMove(const s_board *pos , const int from , const int to ,  const s_movelist *list)
{
    if(RanksBrd[from]==RANK_7)
    {
...
void GenerateAllMoves(const s_board *pos , const s_movelist *list)
{
    ASSERT(CheckBoard(pos));
    int sq=0;int t_sq=0;int pce = EMPTY;
